 ...
 */
public class ActivitySwitchOrderActivity1 extends DemoBaseActivity {
    @BindView(R.id.text)
    TextView mText;
    ...
    public void setupView() {
        super.setupView();
        mText.setText("start activity2 ");
    }

    @OnClick(value = R.id.text)
    public void onClick(View v) {
        startActivity(new Intent(ActivitySwitchOrderActivity1.this, ActivitySwitchOrderActivity2.class));
    }
}
